...
const { createBooking, getBooking, getMyBookings, getAgencyBookings, cancelBooking, payBooking, confirmBooking, completeBooking, getBookingCalendar } = require('../controllers/bookingController');
...
router.get('/calendar', protect, authorizeRoles('AGENCY'), getBookingCalendar);
