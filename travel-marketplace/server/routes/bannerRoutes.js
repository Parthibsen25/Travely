...
router.post('/', protect, authorizeRoles('ADMIN'), uploadBannerImage.single('image'), banner.createBanner);
router.put('/:id', protect, authorizeRoles('ADMIN'), uploadBannerImage.single('image'), banner.updateBanner);
